const atSettings = {
	initialise: {
		version: '',
		basepath: 'https://SadAugust.github.io/AutoTrimps-Loader/',
		basepathOriginal: 'https://SadAugust.github.io/AutoTrimps-Loader/',
		loaded: false
	},
	modules: {
		path: 'modules/',
...
function loadScriptsAT() {
	...
	(async function () {
		try {
			...
			const stylesheets = ['https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css', `${atSettings.initialise.basepath}css/tabs.css`, `${atSettings.initialise.basepath}css/perky.css`];
