...
function initialiseAllSettings() {
	...
	if (displayC2) {
		...
		createSetting('mayhem',
			...
			function () {
				return (((!getPageSetting('c2disableFinished') || game.global.mayhemCompletions < game.challenges.Mayhem.maxRuns) && game.stats.highestRadLevel.valueTotal() >= 100) || challengeActive('Mayhem'))
			});
		...
		createSetting('pandemonium',
			...
			function () { return (((!getPageSetting('c2disableFinished') || game.global.pandCompletions < game.challenges.Pandemonium.maxRuns) && game.stats.highestRadLevel.valueTotal() >= 150) || challengeActive('Pandemonium')) });
