...
function buyPrestigeMaybe(equipName, resourceSpendingPct = 1, maxLevel = Infinity) {
	...
	const oneLevelStat = Math.round(equipment[equipStat] * Math.pow(1.19, Math.max(0, equipment.prestige - game.global.druopitinityDefeated) * game.global.prestige[equipStat] + 1));
