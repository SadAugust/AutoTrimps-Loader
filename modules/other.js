...
function challengesUnlockedObj(universe = currSettingUniverse, excludeSpecial, excludeFused) {
	...
	if (universe === 1) {
		obj = {
			...
			Liquified: { unlockZone: 881, unlockedIn: ['oneOff'] },
			Finale: { unlockZone: 890, unlockedIn: ['c2', 'oneOff'] },
	...
	if (universe === 2) {
		obj = {
			...
			Houseless: { unlockZone: 300, unlockedIn: ['c2', 'oneOff'] },
			Doubleless: { unlockZone: 375, unlockedIn: ['oneOff'] },
			Randomized: { unlockZone: 450, unlockedIn: ['c2', 'oneOff'] }
		};
	}
